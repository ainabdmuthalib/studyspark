					  ...
					  <!-- breadcrumb -->
                        ...
                        <div id="block_bg" class="block">
                            ...
                            <div class="block-content collapse in">
								...
								<br>
								<button name="post" class="btn btn-info" onclick="return validateAnnouncement()"><i class="icon-check icon-large"></i> Post</button>
								</form>
                                </div>
								...
								<?php
									...
									if (trim($content) == '') {
										echo '<div class="alert alert-danger" style="margin-bottom:15px;"><i class="icon-warning-sign"></i> Please write an announcement before posting.</div>';
									} else {
                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
								 ...
								 ?>
											...
											<strong><i class="icon-calendar"></i> <?php echo date('M d, Y h:i A', strtotime($row['date'])); ?></strong>
	...
	$(document).ready( function() {
		...
		function validateAnnouncement() {
			...
			if (plainText === '') {
				...
				errorDiv.innerHTML = '<i class="icon-warning-sign"></i> Please write an announcement before posting.';
		...
		document.getElementById('announcement-form').addsubmit = function(e) {
