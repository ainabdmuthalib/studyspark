				      ...
				      <!-- block -->
                        <div id="block_bg" class="block">
                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
								<form class="" action="assign_save.php<?php echo '?id='.$get_id; ?>" method="post" enctype="multipart/form-data" name="upload" id="assignment-form" onsubmit="return validateAssignment()">
                        ...
                        <div class="control-group">
                            <div class="controls">
                                <input type="text" name="name" Placeholder="File Name"  class="input" id="fileName">
                                <div id="name-error" class="error-message" style="display: none; color: #dc3545; font-size: 12px; margin-top: 5px;">
                                    <i class="icon-warning-sign"></i> Please enter a file name.
                                </div>
                            </div>
                        </div>
                        <div class="control-group">
