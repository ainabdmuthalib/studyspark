<div class="span3" id="sidebar">
	<img id="avatar" src="admin/<?php echo $row['location']; ?>" class="img-polaroid">
			<ul class="nav nav-list bs-docs-sidenav nav-collapse collapse">
				...
				<li class="active"><a href="leaderboard_progress_lecturer.php<?php echo '?id='.$get_id; ?>"><i class="icon-chevron-right"></i><i class="icon-trophy"></i>&nbsp;Leaderboard Progress</a></li>
				...
				<li class=""><a href="discussion_teacher.php<?php echo '?id='.$get_id; ?>"><i class="icon-chevron-right"></i><i class="icon-comments-alt"></i>&nbsp;Discussion</a></li>
				<li class=""><a href="chatroom_teacher.php<?php echo '?id='.$get_id; ?>"><i class="icon-chevron-right"></i><i class="icon-comment"></i>&nbsp;Chatroom</a></li>
			</ul>
